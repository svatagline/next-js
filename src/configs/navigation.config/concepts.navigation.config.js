...
const conceptsNavigationConfig = [
    {
        ...
        subMenu: [
            ...
            // nextjs concepts
            {
                ...
                path: '',
                title: 'NextJs',
                translateKey: 'nav.conceptsNextJs.nextjs',
                icon: 'learning',
                type: NAV_ITEM_TYPE_COLLAPSE,
                authority: [ADMIN, USER],
                meta: {
                    description: {
                        translateKey: 'nav.conceptsNextJs.nextjsDesc',
                        label: 'Concept of NextJs',
                    },
                },
                subMenu: [
                    {
                        key: 'concepts.projects.scrumBoard',
                        path: `${CONCEPTS_PREFIX_PATH}/nextjs/routing`,
                        title: 'Routing',
                        translateKey: 'nav.conceptsNextJs.routing',
                        icon: 'projectScrumBoard',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [ADMIN, USER],
                        meta: {
                            description: {
                                translateKey: 'nav.conceptsNextJs.routingDesc',
                                label: 'Manage your scrum workflow',
                            },
                        },
                        subMenu: [],
